...
def ssd_main_custom(prompt, outdir, plms=True, parser_type='constituency', conjunction=True):
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/storage/shayshomerchai/projects/synthesize_colors_in_context/enviroment/src/Structured-Diffusion-Guidance/configs/stable-diffusion/v1-inference.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/storage/shayshomerchai/projects/synthesize_colors_in_context/enviroment/src/Structured-Diffusion-Guidance/models/ldm/stable-diffusion-v1/model.ckpt",
    ...
    opt.outdir = outdir
    opt.plms = plms
    opt.parser_type = parser_type
    opt.conjunction = conjunction
    # due to double use of config name we force here the yaml
    opt.config = "/storage/shayshomerchai/projects/synthesize_colors_in_context/enviroment/src/Structured-Diffusion-Guidance/configs/stable-diffusion/v1-inference.yaml"
    print(opt)
