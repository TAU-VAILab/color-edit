...
def run_pair_color_acc_best_with_swap(organized_path, output_path):
    ...
    def read_image_quantize_and_find_best_match_to_colors(image_path, mask1, mask2, n_clusters_colors, color_tested_rgb_value1, color_tested_rgb_value2, threshold_percent, save_path="result.png", prompt="", method=""):
        ...
        best_color_repr1_1, best_color_distance1_1, rgb_l2_diff1_1 = process_quantized_area(image_arr_quantized1, mask1, color_tested_rgb_value1, threshold_percent)
        best_color_repr1_2, best_color_distance1_2, rgb_l2_diff1_2 = process_quantized_area(image_arr_quantized1, mask1, color_tested_rgb_value2, threshold_percent)
        if best_color_distance1_1 <= best_color_distance1_2:
            best_color_repr1, best_color_distance1, rgb_l2_diff1 = best_color_repr1_1, best_color_distance1_1, rgb_l2_diff1_1
        else:
             best_color_repr1, best_color_distance1, rgb_l2_diff1 = best_color_repr1_2, best_color_distance1_2, rgb_l2_diff1_2 
        best_color_repr2_2, best_color_distance2_2, rgb_l2_diff2_2 = process_quantized_area(image_arr_quantized2, mask2, color_tested_rgb_value2, threshold_percent)
        best_color_repr2_1, best_color_distance2_1, rgb_l2_diff2_1 = process_quantized_area(image_arr_quantized2, mask2, color_tested_rgb_value1, threshold_percent)
        if best_color_distance2_2 <= best_color_distance2_1:
            best_color_repr2, best_color_distance2, rgb_l2_diff2 = best_color_repr2_2, best_color_distance2_2, rgb_l2_diff2_2
        else:
            best_color_repr2, best_color_distance2, rgb_l2_diff2 = best_color_repr2_1, best_color_distance2_1, rgb_l2_diff2_1 
